...
function Innokassa_order_meta_check($order){
	?>
	<a href="https://crm.innokassa.ru/" target="_blank" style="padding: 10px 15px; background:#002365; color:#fff; text-decoration: unset; border-radius: 10px; width: max-content; display: block; margin: 60px 0 0 auto;">Управление чеками</a>
