    ...
    <form method="post" action="options.php">
        ...
        <div class="flex_div">
            <div>
                ...
                <input name="innokassa_option_actor_id" value="<?php echo get_option('innokassa_option_actor_id'); ?>" />
            </div>
            <div>
                <label>Токен актора</label>
                <input name="innokassa_option_actor_token" value="<?php echo get_option('innokassa_option_actor_token'); ?>" />
            </div>
            <div>
        ...
        <div class="flex_div">
            <div>
                ...
                <input name="innokassa_option_place_of_settlement" value="<?php echo get_option('innokassa_option_place_of_settlement'); ?>" />
            </div>
            <div>
